...
class Program {
    friend  void run_Program(Program& P,EvalState& state);
    friend  void list_Program(Program& P);
public:
/*
 * Constructor: Program
 ...
 */
   ...
   bool Line_inserted(int lineNumber);
...
private:
    map<int,Statement*> Statement_map;
    map<int,string>     Source_map;
